  ...
  return (
    <div id='home' className='w-full min-h-screen lg:h-screen flex flex-wrap lg:justify-between lg:items-center justify-center pt-32 lg:pt-0 lg:mt-0 overflow-hidden'>
      <div className='text-center lg:text-left w-full lg:w-[40%]'>
        ...
        <PrimaryButton href={'https://drive.google.com/file/d/1JOObztK4qQo0aURDrbT6gY3uD3ZQ2Ox7/view?usp=share_link'} additional={'mx-auto lg:mx-0 hover:-translate-y-1 transition ease-in-out duration-300'}>MY RESUME</PrimaryButton>
      </div>
