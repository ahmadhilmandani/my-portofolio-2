        ...
        <div className="lg:flex hidden justify-between items-end fixed -z-10 w-full h-screen bottom-0 left-0 right-0 lg:px-6 px-4 bg-transparent">
            <div className="flex justify-between items-center flex-col h-2/3">
                <a href="https://github.com/ahmadhilmandani" target="_blank">
                    <IconBrandGithub stroke={2} className="text-dark-orange-color hover:text-dark-green-color hover:-translate-y-1 transition ease-in-out duration-300" />
                </a>
                <a href="mailto:ahmadhilmanlagi@gmail.com" target="_blank">
                    <IconBrandGmail stroke={2} className="text-dark-orange-color hover:text-dark-green-color hover:-translate-y-1 transition ease-in-out duration-300" />
                </a>
                <a href="https://www.linkedin.com/in/ahmad-hilman-b52b661b7/" target="_blank">
                    <IconBrandLinkedin stroke={2} className="text-dark-orange-color hover:text-dark-green-color hover:-translate-y-1 transition ease-in-out duration-300" />
                </a>
                <a href="https://www.instagram.com/ahmadhilmandani/" target="_blank" >
                    <IconBrandInstagram stroke={2} className="text-dark-orange-color hover:text-dark-green-color hover:-translate-y-1 transition ease-in-out duration-300" />
                </a>
